...
type UserProfile struct {
	...
	ExistingConditions []string   `db:"existing_conditions" json:"existing_conditions"` // stored as JSONB
	DoctorUserID       *uuid.UUID `db:"doctor_user_id" json:"doctor_user_id"`
	CaregiverUserID    *uuid.UUID `db:"caregiver_user_id" json:"caregiver_user_id"`
	BaselineProfileID  *uuid.UUID `db:"baseline_profile_id" json:"baseline_profile_id"`
	CreatedAt          time.Time  `db:"created_at" json:"created_at"`
	UpdatedAt          time.Time  `db:"updated_at" json:"updated_at"`
}
...
type SleepSession struct {
	...
	QualityScore     float64    `db:"quality_score" json:"quality_score"` // 0–100
	DisturbanceCount int        `db:"disturbance_count" json:"disturbance_count"`
	IsDisturbed      bool       `db:"is_disturbed" json:"is_disturbed"`
	AvgHeartRate     *float64   `db:"avg_heart_rate" json:"avg_heart_rate"`
	AvgSpO2          *float64   `db:"avg_spo2" json:"avg_spo2"`
	AvgMovementScore *float64   `db:"avg_movement_score" json:"avg_movement_score"`
	CreatedAt        time.Time  `db:"created_at" json:"created_at"`
	UpdatedAt        time.Time  `db:"updated_at" json:"updated_at"`
}
...
type DoctorProtocol struct {
	...
	State          ProtocolState  `db:"state" json:"state"`
	TriggerOutcome TriggerOutcome `db:"trigger_outcome" json:"trigger_outcome"`
	DoctorApproved bool           `db:"doctor_approved" json:"doctor_approved"`
...
type ProtocolRule struct {
	...
	MetricType     MetricType `db:"metric_type" json:"metric_type"`
	Operator       string     `db:"operator" json:"operator"` // gt, lt, gte, lte, eq
	ThresholdValue float64    `db:"threshold_value" json:"threshold_value"`
	RiskLevel      RiskLevel  `db:"risk_level" json:"risk_level"` // minimum risk to trigger
	CreatedAt      time.Time  `db:"created_at" json:"created_at"`
}
...
type DispenserDevice struct {
	ID          uuid.UUID  `db:"id" json:"id"`
	PatientID   uuid.UUID  `db:"patient_id" json:"patient_id"`
	DeviceCode  string     `db:"device_code" json:"device_code"` // MQTT identifier
	Model       string     `db:"model" json:"model"`
	FirmwareVer string     `db:"firmware_ver" json:"firmware_ver"`
...
type DeviceCommand struct {
	...
	CommandType    string        `db:"command_type" json:"command_type"` // dispense | hold | reset
	Payload        string        `db:"payload" json:"payload"`           // JSONB
